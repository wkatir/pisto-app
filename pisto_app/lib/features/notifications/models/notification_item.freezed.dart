...
mixin _$NotificationItem {
 ...
 String get id; String get businessId; String get type; String get title; String get body; String? get entityType; String? get entityId; String? get readAt; DateTime get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,businessId,type,title,body,entityType,entityId,readAt,createdAt);

@override
String toString() {
  return 'NotificationItem(id: $id, businessId: $businessId, type: $type, title: $title, body: $body, entityType: $entityType, entityId: $entityId, readAt: $readAt, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String businessId, String type, String title, String body, String? entityType, String? entityId, String? readAt, DateTime createdAt
});
...
/// Create a copy of NotificationItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? businessId = null,Object? type = null,Object? title = null,Object? body = null,Object? entityType = freezed,Object? entityId = freezed,Object? readAt = freezed,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String businessId,  String type,  String title,  String body,  String? entityType,  String? entityId,  String? readAt,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NotificationItem() when $default != null:
return $default(_that.id,_that.businessId,_that.type,_that.title,_that.body,_that.entityType,_that.entityId,_that.readAt,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String businessId,  String type,  String title,  String body,  String? entityType,  String? entityId,  String? readAt,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _NotificationItem():
return $default(_that.id,_that.businessId,_that.type,_that.title,_that.body,_that.entityType,_that.entityId,_that.readAt,_that.createdAt);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String businessId,  String type,  String title,  String body,  String? entityType,  String? entityId,  String? readAt,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _NotificationItem() when $default != null:
return $default(_that.id,_that.businessId,_that.type,_that.title,_that.body,_that.entityType,_that.entityId,_that.readAt,_that.createdAt);case _:
  return null;
...
class _NotificationItem extends NotificationItem {
  const _NotificationItem({required this.id, required this.businessId, required this.type, required this.title, required this.body, this.entityType, this.entityId, this.readAt, required this.createdAt}): super._();
...
/// Create a copy of NotificationItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? businessId = null,Object? type = null,Object? title = null,Object? body = null,Object? entityType = freezed,Object? entityId = freezed,Object? readAt = freezed,Object? createdAt = null,}) {
